...
def main():
    ...
    train_dir = '/work/deogun/alali/data/lung_4000png/train'
    #val_dir = 'D:/DATA/JHUBrain/Val/'
    val_dir = '/common/deogun/alali/data/lung_4000png/val'
    ...
    print('batch_size = {}, train_dir = {}, lr={}, max_epochs={}, config_vit={}'.format(batch_size, train_dir, lr, max_epoch, config_vit))
    if cont_training:
        epoch_start = 335
    ...
    train_dataset = datasets.ImageFolder(root=train_dir, transform=train_composed)
    val_dataset = datasets.ImageFolder(root=val_dir, transform=val_composed)
    #val_set = datasets.JHUBrainInferDataset(glob.glob(val_dir + '*.pkl'), transforms=val_composed)
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=4, pin_memory=True)
    val_loader = DataLoader(val_dataset, batch_size=1, shuffle=False, num_workers=4, pin_memory=True, drop_last=True)
    print('check train data loader')
    for d in train_loader:
        print(d)
        break # only print the first one for inspection
    print('check val data loader')
    for d in val_loader:
        print(d)
        break
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        for data in train_loader:
            idx += 1
            print('iterating train_loader. idx={}'.format(idx))
